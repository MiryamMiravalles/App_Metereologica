...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if ("geolocation" in navigator) {
      navigator.geolocation.getCurrentPosition(
        function (position) {
          ...
          resultadoParrafo.textContent = "Obteniendo ubicación. Realizando solicitud a la API...";
      ...
      ubicacionParrafo.textContent = "La geolocalización no está disponible en este navegador.";
    }
  }
  ...
  function obtenerPronosticoLluvia(latitude, longitude) {
    ...
    fetch(url)
      ...
      .catch((error) => {
        resultadoParrafo.textContent = "Error al obtener el pronóstico: " + error.message;
      });
  }
});
